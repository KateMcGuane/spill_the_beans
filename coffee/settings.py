...
# Reidrection URLs added for after logged in/out
SITE_ID = 1
LOGIN_REDIRECT_URL = '/'
LOGOUT_REDIRECT_URL = '/'
...
# Allows development & production (Heroku) server to add blog post
# from admin panel
...
# Breaking the long line into multiple lines using parentheses
...
# Tells Django not to expect email verification
